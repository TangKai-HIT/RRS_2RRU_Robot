classdef RRS_2RRU_Hybrid_Syms < handle
    %RRS_2RRU_HYBRID_SYMS Support symbolic computations
    ...
    methods
        function obj = RRS_2RRU_Hybrid_Syms(RRS_2RRU, z_p_init, d1_init, pkm_y_offset, pkm_z_offset)
            ...
            if nargin > 0
                ...
                Tf_0_pkm = expMapSE3(obj.twist_1, obj.theta1) * expMapSE3(obj.twist_2, d1_init) * mytrvec2tform([0, obj.pkm_y_offset, obj.pkm_z_offset]);
                ...
                obj.Tf_C3_P = mytrvec2tform([0,-obj.RRS_2RRU.r, 0]);
        ...
        function Tf_tool = forwardKine(obj, theta1, d1, z_p, alpha, beta)
            Tf_pkm = expMapSE3(obj.twist_1, theta1) * expMapSE3(obj.twist_2, d1) * mytrvec2tform([0, obj.pkm_y_offset, obj.pkm_z_offset]);
        ...
        function config = invKine(obj,Tf_BTC)
            ...
            Tf_BTC_P = mytrvec2tform([0 0 -obj.RRS_2RRU.toolHight]);
            ...
            proj = obj.twist_1(1:3) * obj.twist_1(1:3)';
            u_n = u - proj*u;
            v_n = v - proj*v;
            obj.theta1 = atan2(obj.twist_1(1:3)'*cross(u_n, v_n), u_n'*v_n);
            ...
            obj.Tf_0_pkm = obj.Tf_0_P0 * mytrvec2tform([0, obj.pkm_y_offset, obj.pkm_z_offset]);
