...
for i=1:N
    ...
    configs_test(:, i) = Hyd_IK_1([alpha_traj(i), beta_traj(i)], endPos_traj(:, i), R,r,L1,L2,toolHight,pkm_y_offset,pkm_z_offset);
    ...
    J_a_2R(:, :, i) = Hyd_Ja2R_1([alpha_traj(i), beta_traj(i)], endPos_traj(:, i), R,r,L1,L2,toolHight,pkm_y_offset,pkm_z_offset);
    J_a_Pe(:, :, i) = Hyd_JaPe_1([alpha_traj(i), beta_traj(i)], endPos_traj(:, i), R,r,L1,L2,toolHight,pkm_y_offset,pkm_z_offset);
    dconfigs_test(:, i) = J_a_2R(:, :, i)*[dalpha_traj(i); dbeta_traj(i)] + J_a_Pe(:, :, i)*endVel_traj(:, i);
    
    dJ_a2R_d2R = Hyd_dJa2R_d2R_1([alpha_traj(i), beta_traj(i)], endPos_traj(:, i), R,r,L1,L2,toolHight,pkm_y_offset,pkm_z_offset);
    dJ_aPe_d2R = Hyd_dJaPe_d2R_1([alpha_traj(i), beta_traj(i)], endPos_traj(:, i), R,r,L1,L2,toolHight,pkm_y_offset,pkm_z_offset);
    dJ_a2R_dPe = Hyd_dJa2R_dPe_1([alpha_traj(i), beta_traj(i)], endPos_traj(:, i), R,r,L1,L2,toolHight,pkm_y_offset,pkm_z_offset);
    dJ_aPe_dPe = Hyd_dJaPe_dPe_1([alpha_traj(i), beta_traj(i)], endPos_traj(:, i), R,r,L1,L2,toolHight,pkm_y_offset,pkm_z_offset);
